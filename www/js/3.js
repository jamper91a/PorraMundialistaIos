/*
Esta pagina permite crear una Porra y enviar una invitacion por email a los usuarios seleccionados
*/
    ...
    function()
    {
        ...
        $("#btCrear").click(
            function(e)
            {
                ...
                {
                    crearPorra(nombre,premio,informacion,administrador)
                }else{
...
function crearPorra(nombre,premio,informacion,administrador)
{
    ...
    bPopUpOpenCargando("Creando Porra");
    ajax(url,datos,
     function(xml)
             {
