...
$(document).ready(
    function ()
    {
        ...
        $("#facebook").click(
            ...
            {
                e.preventDefault();
                var objParameters = { "picture":"http://www.ejemplosprogramacion.co/wp-content/uploads/2014/05/logoPMgrande.png", "name":"Porra Mundialista", "caption":"Porra Mundialista Android-Ios", "description":"Para este mundial, estoy preparado para jupar las Porras desde mi movil", "link":"http://www.ejemplosprogramacion.co" } 
