/*
Se encarga de mostrar informacion de la Porra seleccionada
*/
var usuarios="",correos="",idBet,nombreBet;
var redireccionar=false,exitPorra=false;
            ...
            function(e)
            {
                ...
                if(usuarios && correos)
                {
                    ...
                    ajax(url,datos,function(xml2)
                         {
                             bPopUpOpen("<p>Un email se envío a tus familiares y amigos para que se unan a la Porra "+nombreBet+"</p>","aceptar");
                             redireccionar=false;
...
function salirPorra(idBet,idUsuario)
{
